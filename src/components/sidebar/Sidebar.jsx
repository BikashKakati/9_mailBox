        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 pt-16 md:pt-4 w-72 min-h-full bg-base-100 text-base-content *:font-bold">
                    ...
                    {currentUser && <p className='px-8 py-2 bg-red-200 rounded-lg mx-auto md:hidden'>{currentUser.email}</p>}
                    <li className='mt-4'><Link to="/compose">Compose</Link></li>
                    <li className='relative'>
                        <Link to="/">Inbox</Link>
                        <span className='absolute right-0 bg-red-200'>{unreadMail}</span>
                    </li>
